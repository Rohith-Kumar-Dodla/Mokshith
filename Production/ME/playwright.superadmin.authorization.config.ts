...
// Prefer local Redis + relaxed AUTH_STRICT for Playwright QA (matches Admin / SA harness).
...
export default defineConfig({
  ...
  testMatch: ['**/superadmin.authorization.spec.ts'],
  fullyParallel: false,
  ...
  reporter: [
    ['html', { outputFolder: 'playwright-report-superadmin-authorization' }],
    ['junit', { outputFile: 'test-results/junit-superadmin-authorization.xml' }],
    ['json', { outputFile: 'test-results/superadmin-authorization-results.json' }],
    ['list'],
  ],
  use: {
