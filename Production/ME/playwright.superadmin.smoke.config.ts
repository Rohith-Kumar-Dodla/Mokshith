...
// Prefer local Redis + relaxed AUTH_STRICT for Playwright QA (matches Admin harness).
...
export default defineConfig({
  ...
  testMatch: ['**/superadmin.smoke.spec.ts'],
  fullyParallel: false,
  ...
  reporter: [
    ['html', { outputFolder: 'playwright-report-superadmin-smoke' }],
    ['junit', { outputFile: 'test-results/junit-superadmin-smoke.xml' }],
    ['json', { outputFile: 'test-results/superadmin-smoke-results.json' }],
    ['list'],
  ],
  use: {
