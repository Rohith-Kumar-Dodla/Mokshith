...
export default defineConfig({
  ...
  testMatch: ['**/superadmin.validation.spec.ts'],
  fullyParallel: false,
  ...
  reporter: [
    ['html', { outputFolder: 'playwright-report-superadmin-validation' }],
    ['junit', { outputFile: 'test-results/junit-superadmin-validation.xml' }],
    ['json', { outputFile: 'test-results/superadmin-validation-results.json' }],
    ['list'],
  ],
  use: {
