...
const ImageUpload = ({
  ...
  const handleFileSelect = async (event) => {
    ...
    try {
      ...
      const userMessage = getUserFacingErrorMessage(err, 'Image upload failed');
      setUploadError(err?.message && err.message !== userMessage ? `${userMessage} (${err.message})` : userMessage);
