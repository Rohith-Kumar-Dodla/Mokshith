...
describe('AdminOrderManagement KPI behavior', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('Total and Completed KPIs use paymentCompleted / paymentMethod filters', async () => {
    render(
      <MemoryRouter>
        <AdminOrderManagement PageHeader={PageHeader} title="Area Orders" subtitle="Test" />
      </MemoryRouter>
    );
