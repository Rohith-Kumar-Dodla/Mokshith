  ...
  return (
    <div className="min-w-0 space-y-6">
      ...
      <section className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm sm:p-6">
        ...
        <dl className="mt-6 grid grid-cols-2 gap-4 sm:max-w-md"><div className="rounded-lg bg-gray-50 p-4"><dt className="text-sm text-gray-500">Categories</dt><dd className="mt-1 text-2xl font-bold text-gray-900">{supplier.categoryCount}</dd></div><div className="rounded-lg bg-gray-50 p-4"><dt className="text-sm text-gray-500">Products</dt><dd className="mt-1 text-2xl font-bold text-gray-900">{supplier.productCount}</dd></div></dl>
      </section>
