...
- Name: authentication.smoke.spec.ts >> Authentication Smoke Suite >> S-AUTHZ-02 | Access protected route with auth (admin)
- Location: tests\smoke\authentication.smoke.spec.ts:102:3
