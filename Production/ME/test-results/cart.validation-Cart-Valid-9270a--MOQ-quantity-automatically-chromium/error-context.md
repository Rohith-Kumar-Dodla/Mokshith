...
- Name: cart.validation.spec.ts >> Cart Validation Certification Suite >> Section E — Frontend Product Listing Validation >> PV-CART-035 | Listing add sends MOQ quantity automatically
- Location: tests\validation\cart.validation.spec.ts:375:5
