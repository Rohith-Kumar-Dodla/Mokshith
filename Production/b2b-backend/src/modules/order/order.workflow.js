...
const transitions = {
  [ORDER_STATUS.CREATED]: [ORDER_STATUS.PENDING_PAYMENT, ORDER_STATUS.CONFIRMED, ORDER_STATUS.FAILED, ORDER_STATUS.CANCELLED],
  [ORDER_STATUS.PENDING_PAYMENT]: [ORDER_STATUS.CONFIRMED, ORDER_STATUS.FAILED, ORDER_STATUS.CANCELLED],
