...
const PartnersPage = lazy(() => import("../modules/superAdmin/pages/PartnersPage.jsx"));
const CustomersPage = lazy(() => import("../modules/superAdmin/pages/CustomersPage.jsx"));
const DeliveryPartnersPage = lazy(() => import("../modules/superAdmin/pages/DeliveryPartnersPage.jsx"));
const AdminsPage = lazy(() => import("../modules/superAdmin/pages/AdminsPage.jsx"));
const CategoriesPage = lazy(() => import("../modules/superAdmin/pages/CategoriesPage.jsx"));
const ProductsPage = lazy(() => import("../modules/superAdmin/pages/ProductsPage.jsx"));
const SAInventoryPage = lazy(() => import("../modules/superAdmin/pages/InventoryPage.jsx"));
const SAOrdersPage = lazy(() => import("../modules/superAdmin/pages/OrdersPage.jsx"));
const SACreditPage = lazy(() => import("../modules/superAdmin/pages/CreditPage.jsx"));
const RevenuePage = lazy(() => import("../modules/superAdmin/pages/RevenuePage.jsx"));
const ConfigurationPage = lazy(() => import("../modules/superAdmin/pages/ConfigurationPage.jsx"));
const FeaturesPage = lazy(() => import("../modules/superAdmin/pages/FeaturesPage.jsx"));
const SASecurityPage = lazy(() => import("../modules/superAdmin/pages/SecurityPage.jsx"));
const AuditPage = lazy(() => import("../modules/superAdmin/pages/AuditPage.jsx"));
const LogsPage = lazy(() => import("../modules/superAdmin/pages/LogsPage.jsx"));
const SASettingsPage = lazy(() => import("../modules/superAdmin/pages/SettingsPage.jsx"));
const SAProfilePage = lazy(() => import("../modules/superAdmin/pages/ProfilePage.jsx"));
...
const ShipmentTrackingPage = lazy(() => import("../modules/shipment/pages/ShipmentTrackingPage.jsx"));
const NotificationPage = lazy(() => import("../modules/notification/pages/NotificationPage.jsx"));
const SearchPage = lazy(() => import("../modules/search/SearchPage.jsx"));
const VendorCreditPage = lazy(() => import("../modules/credit/pages/VendorCreditPage.jsx"));
const VendorReviewsPage = lazy(() => import("../modules/review/pages/VendorReviewsPage.jsx"));
const AdminLogisticsPage = lazy(() => import("../modules/logistics/pages/AdminLogisticsPage.jsx"));
const SupportTicketsPage = lazy(() => import("../modules/support/pages/SupportTicketsPage.jsx"));
const MonitoringPage = lazy(() => import("../modules/monitoring/pages/MonitoringPage.jsx"));

// Public pages
const PricingPage = lazy(() => import("../modules/public/pages/PricingPage.jsx"));
const SolutionsPage = lazy(() => import("../modules/public/pages/SolutionsPage.jsx"));
const ContactPage = lazy(() => import("../modules/public/pages/ContactPage.jsx"));
const AboutPage = lazy(() => import("../modules/public/pages/AboutPage.jsx"));
    ...
    <Suspense fallback={<LoadingFallback />}>
      ...
      {/* PUBLIC ROUTES */}
        ...
        <Route element={
          ...
          <Route path={routes.ADMIN_LOGISTICS} element={<AdminLogisticsPage />} />
          <Route path={routes.ADMIN_SUPPORT} element={<SupportTicketsPage />} />
          ...
          <Route path={routes.VENDOR_CREDIT} element={<VendorCreditPage />} />
          <Route path={routes.VENDOR_REVIEWS} element={<VendorReviewsPage />} />
        </Route>
        ...
        <Route element={
          ...
          <Route path={routes.SUPER_ADMIN_PARTNERS} element={<PartnersPage />} />
          <Route path={routes.SUPER_ADMIN_CUSTOMERS} element={<CustomersPage />} />
          <Route path={routes.SUPER_ADMIN_DELIVERY_PARTNERS} element={<DeliveryPartnersPage />} />
          <Route path={routes.SUPER_ADMIN_ADMINS} element={<AdminsPage />} />
          <Route path={routes.SUPER_ADMIN_CATEGORIES} element={<CategoriesPage />} />
          <Route path={routes.SUPER_ADMIN_PRODUCTS} element={<ProductsPage />} />
          <Route path={routes.SUPER_ADMIN_INVENTORY} element={<SAInventoryPage />} />
          <Route path={routes.SUPER_ADMIN_ORDERS} element={<SAOrdersPage />} />
          <Route path={routes.SUPER_ADMIN_CREDIT} element={<SACreditPage />} />
          <Route path={routes.SUPER_ADMIN_REVENUE} element={<RevenuePage />} />
          <Route path={routes.SUPER_ADMIN_CONFIGURATION} element={<ConfigurationPage />} />
          <Route path={routes.SUPER_ADMIN_FEATURES} element={<FeaturesPage />} />
          <Route path={routes.SUPER_ADMIN_SECURITY} element={<SASecurityPage />} />
          <Route path={routes.SUPER_ADMIN_AUDIT} element={<AuditPage />} />
          <Route path={routes.SUPER_ADMIN_MONITORING} element={<MonitoringPage />} />
          <Route path={routes.SUPER_ADMIN_LOGS} element={<LogsPage />} />
          <Route path={routes.SUPER_ADMIN_SETTINGS} element={<SASettingsPage />} />
          <Route path={routes.SUPER_ADMIN_PROFILE} element={<SAProfilePage />} />
          {/* Legacy routes for backward compatibility */}
          <Route path={routes.SUPER_ADMIN_VENDORS} element={<PartnersPage />} />
          <Route path={routes.SUPER_ADMIN_DELIVERY} element={<DeliveryPartnersPage />} />
        </Route>
